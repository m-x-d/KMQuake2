...
cvar_t *player_jump_sounds; // Whether to play grunting sound when the player jumps
...
cvar_t *tech_flags; // Determines which techs will show in the game: 1 = resist, 2 = strength, 4 = haste, 8 = regen, 16 = vampire, 32 = ammogen
...
void InitLithiumVars()
{
	...
	tech_spawn = gi.cvar("tech_spawn", "0.1", 0);
