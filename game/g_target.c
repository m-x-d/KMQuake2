...
{
	float		save;
	const int type = (self->spawnflags & 1 ? TE_EXPLOSION1_BIG : TE_EXPLOSION1); //Knightmare- big explosion //mxd. Also reflection
	...
	if(level.num_reflectors)
		ReflectExplosion (type, self->s.origin); //mxd. TE_EXPLOSION1 -> type
