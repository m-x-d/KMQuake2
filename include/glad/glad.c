/*
    ...
    OpenGL loader generated by glad 0.1.30 on Fri Jun 21 15:30:01 2019.
    ...
    Commandline:
        --profile="compatibility" --api="gl=2.1" --generator="c" --spec="gl" --no-loader --extensions="GL_ARB_fragment_program,GL_ARB_multitexture,GL_ARB_texture_compression,GL_ARB_texture_env_combine,GL_ARB_vertex_program,GL_ATI_separate_stencil,GL_EXT_compiled_vertex_array,GL_EXT_draw_range_elements,GL_EXT_stencil_two_side,GL_EXT_stencil_wrap,GL_EXT_texture_filter_anisotropic,GL_NV_texture_shader"
    Online:
        https://glad.dav1d.de/#profile=compatibility&language=c&specification=gl&api=gl%3D2.1&extensions=GL_ARB_fragment_program&extensions=GL_ARB_multitexture&extensions=GL_ARB_texture_compression&extensions=GL_ARB_texture_env_combine&extensions=GL_ARB_vertex_program&extensions=GL_ATI_separate_stencil&extensions=GL_EXT_compiled_vertex_array&extensions=GL_EXT_draw_range_elements&extensions=GL_EXT_stencil_two_side&extensions=GL_EXT_stencil_wrap&extensions=GL_EXT_texture_filter_anisotropic&extensions=GL_NV_texture_shader
*/
...
static int get_exts(void) {
    ...
    if(max_loaded_major < 3) {
#endif
        exts = (const char *)qglGetString(GL_EXTENSIONS);
#ifdef _GLAD_IS_SOME_NEW_VERSION
    } else {
        unsigned int index;
        ...
        for(index = 0; index < (unsigned)num_exts_i; index++) {
            const char *gl_str_tmp = (const char*)qglGetStringi(GL_EXTENSIONS, index);
...
int gladLoadGLLoader(GLADloadproc load) {
	...
	if(qglGetString == NULL) return 0;
	if(qglGetString(GL_VERSION) == NULL) return 0;
	find_coreGL();
